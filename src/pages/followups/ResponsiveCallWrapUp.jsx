...
import { ResponsiveStepWorkflow } from '@/components/followups/ResponsiveStepWorkflow'
import { ResponsiveTranscriptUpload } from '@/components/followups/ResponsiveTranscriptUpload'
import { CallInsightsViewer } from '@/components/followups/CallInsightsViewer'
import { GridContainer, GridRow, GridCol, GridCard, Section, VerticalSpacer } from '@/components/layout/GridSystem'
...
export const ResponsiveCallWrapUp = () => {
  ...
  return (
    <GridContainer>
      <div className="space-y-6">
        ...
        {/* Step-Based Workflow - Full Width */}
        <ResponsiveStepWorkflow 
          ...
          <>
            ...
            {completedSteps.includes(1) && !isProcessing && (
              <Section>
                <GridRow>
                  <GridCol span={12}>
                    <GridCard elevation="medium" className="bg-green-50 border-green-200">
                      <div className="space-y-4">
                        <div className="flex items-center space-x-3">
        ...
        {currentStep === 3 && completedSteps.includes(3) && (
          <Section>
            <GridRow>
              <GridCol span={12} lg={8} offset={0} offsetLg={2}>
                <GridCard elevation="high">
