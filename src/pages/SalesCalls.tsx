        ...
        <TabsContent value="fireflies" className="mt-6">
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  <CardTitle>Fireflies Transcripts</CardTitle>
                  {firefliesConnected ? (
                ...
                {firefliesConnected && (
                  <Button
                    onClick={syncFirefliesTranscripts}
            ...
            <CardContent>
              {!firefliesConnected ? (
                <div className="text-center py-12">
                  <ExternalLink className="w-16 h-16 mx-auto mb-4 opacity-50 text-muted-foreground" />
                  <h3 className="text-lg font-medium mb-2">Fireflies Not Connected</h3>
                  <p className="text-muted-foreground mb-4">
                    Connect your Fireflies account in Settings to sync your meeting transcripts.
                  </p>
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-muted-foreground mb-4">
                    No Fireflies transcripts found for your account. Try syncing to get the latest transcripts.
                  </p>
                  <Button onClick={syncFirefliesTranscripts} disabled={isSyncingFireflies}>
                    {isSyncingFireflies ? (
                      <>
                        <Loader2 className="w-4 h-4 mr-2 animate-spin" />
                        Syncing...
                        ...
                        <div className="flex-1">
                          <div className="flex items-center space-x-2 mb-2">
                            ...
                            <Badge
                              ...
                              className="text-xs"
                            >
                              {file.is_processed ? "Processed" : "Not Processed"}
                            </Badge>
                          </div>
                          ...
                          <div className="grid grid-cols-2 gap-4 text-sm text-muted-foreground mb-3">
                            <div className="flex items-center space-x-1">
                              ...
                              <span>
                                {file.datestring
                                  ? new Date(file.datestring).toLocaleDateString()
                                  : "No date"}
                              </span>
                            </div>
                            <div className="flex items-center space-x-1">
                              <Clock className="w-4 h-4" />
                              <span>
                                {file.duration ? `${file.duration} min` : "Unknown duration"}
                              </span>
                            </div>
                            <div className="flex items-center space-x-1">
                              <User className="w-4 h-4" />
                              <span>
                                {file.organizer_email || "Unknown organizer"}
                              </span>
                            </div>
                            <div className="flex items-center space-x-1">
                              <User className="w-4 h-4" />
                              <span>
                                {file.participants?.length || 0} participants
                              </span>
                            </div>
                          </div>
                          ...
                          {file.participants && file.participants.length > 0 && (
                            <div className="text-xs text-muted-foreground">
                              ...
                              {Array.isArray(file.participants) 
                                ? file.participants.join(", ")
                                : JSON.stringify(file.participants)
                              }
                            </div>
                          )}
                        </div>
                          ...
                          {!file.is_processed && (
                            <Button
                              ...
                              onClick={() => {
                                ...
                                toast.info("Processing functionality coming soon");
                              }}
                            >
