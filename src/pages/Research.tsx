    ...
    <div className="max-w-7xl mx-auto flex flex-col h-[calc(100vh-4rem)]">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="p-6">
              ...
              researchResult.prospectProfiles.length > 0 ? (
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {researchResult.prospectProfiles.map((profile, index) => (
                    <Card
                     className="cursor-pointer hover:shadow-lg hover:border-blue-200 transition-all duration-200 relative group bg-gradient-to-br from-white to-gray-50/50"
              ...
              <CardContent className="p-6">
                     ...
                     <CardContent className="pt-0 space-y-4">
                       ...
                       <div className="space-y-2">
                         <div className="flex items-center space-x-2">
                           ...
                           <h4 className="text-sm font-semibold text-gray-800">Company Overview</h4>
                         </div>
                         <p className="text-sm text-gray-600 leading-relaxed line-clamp-3">
                           {research.summary_note || 
                            research.company_analysis?.substring(0, 200) + '...' || 
                       ...
                       <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                         <div className="flex items-center space-x-4">
                           {research.prospectProfiles && research.prospectProfiles.length > 0 && (
                             <div className="flex items-center space-x-1">
                               <User className="w-3 h-3 text-blue-600" />
                               <span className="text-xs text-gray-600 font-medium">
                                 {research.prospectProfiles.length} Profile{research.prospectProfiles.length !== 1 ? 's' : ''}
                               </span>
                             </div>
                           )}
                           {research.market_trends && research.market_trends.length > 0 && (
                             <div className="flex items-center space-x-1">
                               ...
                               <span className="text-xs text-gray-600 font-medium">
                                 {research.market_trends.length} Trend{research.market_trends.length !== 1 ? 's' : ''}
                               </span>
                             </div>
                           )}
                           {research.growth_opportunities && research.growth_opportunities.length > 0 && (
                             <div className="flex items-center space-x-1">
                               <Target className="w-3 h-3 text-purple-600" />
                               <span className="text-xs text-gray-600 font-medium">
                                 {research.growth_opportunities.length} Opportunit{research.growth_opportunities.length !== 1 ? 'ies' : 'y'}
                               </span>
                             </div>
                           )}
                         </div>
                         <Badge 
                           variant="secondary" 
                           className="text-xs bg-gray-100 text-gray-700 hover:bg-blue-50 hover:text-blue-700 transition-colors group-hover:bg-blue-100"
                         >
               ...
               <div className="text-center py-12">
                 ...
                 <p className="text-gray-600 mb-6">
                   Start by researching a company to see your history here
                 </p>
                 <Button 
         ...
         {/* Results Tab */}
         <TabsContent value="results" className="mt-6 min-h-[400px]">
           {researchData ? (
             <div className="space-y-6">
