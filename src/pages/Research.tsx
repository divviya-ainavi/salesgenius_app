...
`.trim();
  ...
  return !researchResult?.is_new ? (
    ...
    <div className="max-w-7xl mx-auto flex flex-col h-[calc(100vh-4rem)]">
      ...
      <Dialog open={deleteConfirmDialog.isOpen} onOpenChange={cancelDeleteResearch}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to delete the research for "{deleteConfirmDialog.companyName}"? 
