                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center space-x-2 text-sm">
                      ...
                      {research?.prospect_profiles &&
                          ...
                          <div className="pt-2 border-t border-border">
                            ...
                            <div className="space-y-1">
                              {research?.prospect_profiles
                                ...
                                ?.map((profile, index) => (
                        {/* Static Elements */}
                        {researchData.demand_side.staticElements && (
                            ...
                            <div className="grid gap-4">
                              ...
                              {researchData.demand_side.staticElements.industryRequirements && (
                                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                  <h5 className="font-medium text-blue-900 mb-2">Industry Requirements</h5>
                                  <ul className="space-y-2">
                                    {researchData.demand_side.staticElements.industryRequirements.map((req, index) => (
                              ...
                              {/* Operational Needs */}
                              {researchData.demand_side.staticElements.operationalNeeds && (
                                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                                  <h5 className="font-medium text-green-900 mb-2">Operational Needs</h5>
                                  <ul className="space-y-2">
                                    {researchData.demand_side.staticElements.operationalNeeds.map((need, index) => (
                                      <li key={index} className="text-sm text-gray-700 flex items-start space-x-2">
                              ...
                              {/* Recurring Problems */}
                              {researchData.demand_side.staticElements.recurringProblems && (
                                <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
                                  <h5 className="font-medium text-orange-900 mb-2">Recurring Problems</h5>
                                  <ul className="space-y-2">
                                    {researchData.demand_side.staticElements.recurringProblems.map((problem, index) => (
                                      <li key={index} className="text-sm text-gray-700 flex items-start space-x-2">
                        ...
                        {/* Dynamic Elements */}
                        {researchData.demand_side.dynamicElements && (
                                  <h5 className="font-medium text-purple-900 mb-2">Geographic & Size Requirements</h5>
                            <h4 className="font-semibold text-gray-900 mb-4 flex items-center space-x-2">
                            ...
                            <div className="grid gap-4">
                              {/* Market Pressures */}
                              {researchData.demand_side.dynamicElements.marketPressures && (
                                <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                                  <h5 className="font-medium text-red-900 mb-2">Market Pressures</h5>
                                  <ul className="space-y-2">
                                    {researchData.demand_side.dynamicElements.marketPressures.map((pressure, index) => (
                                      <li key={index} className="text-sm text-gray-700 flex items-start space-x-2">
                              ...
                              {researchData.demand_side.dynamicElements.technologyDisruptions && (
                                <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-4">
                                  <h5 className="font-medium text-indigo-900 mb-2">Technology Disruptions</h5>
                                  <ul className="space-y-2">
                                    {researchData.demand_side.dynamicElements.technologyDisruptions.map((disruption, index) => (
                                      <li key={index} className="text-sm text-gray-700 flex items-start space-x-2">
                              ...
                              {/* Competitive Threats */}
                              {researchData.demand_side.dynamicElements.competitiveThreats && (
                                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                                  <h5 className="font-medium text-yellow-900 mb-2">Competitive Threats</h5>
                                  <ul className="space-y-2">
                                    {researchData.demand_side.dynamicElements.competitiveThreats.map((threat, index) => (
                                      <li key={index} className="text-sm text-gray-700 flex items-start space-x-2">
                              ...
                              {researchData.demand_side.dynamicElements.growthPhaseDemands && (
                                <div className="bg-teal-50 border border-teal-200 rounded-lg p-4">
                                  <h5 className="font-medium text-teal-900 mb-2">Growth Phase Demands</h5>
                                  <ul className="space-y-2">
                                    {researchData.demand_side.dynamicElements.growthPhaseDemands.map((demand, index) => (
                                      <li key={index} className="text-sm text-gray-700 flex items-start space-x-2">
