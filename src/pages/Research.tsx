          ...
          <Card>
            <CardContent className="text-center py-12">
              ...
              <p className="text-muted-foreground mb-4">
                {historySearch.trim()
                  ? "No research matches your search criteria."
                ...
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    <CardTitle className="text-lg flex items-center space-x-2">
                      ...
                      <span>{research.company_name}</span>
                    </CardTitle>
                  ...
                  <CardDescription className="flex items-center space-x-2">
                    ...
                    <span className="truncate">{research.company_url}</span>
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="grid lg:grid-cols-2 gap-6">
                    {/* Static Demand Elements */}
                    {research.demand_side.staticElements && (
                      <div className="space-y-4">
                        ...
                        {research.demand_side.staticElements.industryRequirements && (
                          <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                            ...
                            <div className="p-4">
                              <ul className="space-y-3">
                                {research.demand_side.staticElements.industryRequirements.map((req, index) => (
                        ...
                        {/* Operational Needs */}
                        {research.demand_side.staticElements.operationalNeeds && (
                          <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                            ...
                            <div className="p-4">
                              <ul className="space-y-3">
                                {research.demand_side.staticElements.operationalNeeds.map((need, index) => (
                                  <li key={index} className="text-sm text-gray-700 flex items-start space-x-3">
                        ...
                        {/* Recurring Problems */}
                        {research.demand_side.staticElements.recurringProblems && (
                          <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                            ...
                            <div className="p-4">
                              <ul className="space-y-3">
                                {research.demand_side.staticElements.recurringProblems.map((problem, index) => (
                                  <li key={index} className="text-sm text-gray-700 flex items-start space-x-3">
                        ...
                        {research.demand_side.staticElements.geoSizeRequirements && (
                          <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                            <div className="px-4 py-3 border-b border-gray-100 bg-purple-50/50">
                              <h5 className="font-medium text-gray-900 flex items-center space-x-2">
                                <div className="w-2 h-2 bg-purple-500 rounded-full"></div>
                                <span>Geographic & Size Requirements</span>
                              </h5>
                            </div>
                            <div className="p-4">
                              <ul className="space-y-3">
                                {research.demand_side.staticElements.geoSizeRequirements.map((req, index) => (
                                  <li key={index} className="text-sm text-gray-700 flex items-start space-x-3">
                    ...
                    {research.demand_side.dynamicElements && (
                      <div className="space-y-4">
                        <h4 className="text-lg font-semibold text-gray-900 mb-4">
                          Dynamic Demand Elements
                        </h4>
                        ...
                        {/* Market Pressures */}
                        {research.demand_side.dynamicElements.marketPressures && (
                          <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                            ...
                            <div className="p-4">
                              <ul className="space-y-3">
                                {research.demand_side.dynamicElements.marketPressures.map((pressure, index) => (
                                  <li key={index} className="text-sm text-gray-700 flex items-start space-x-3">
                        ...
                        {research.demand_side.dynamicElements.technologyDisruptions && (
                          <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                            ...
                            <div className="p-4">
                              <ul className="space-y-3">
                                {research.demand_side.dynamicElements.technologyDisruptions.map((disruption, index) => (
                                  <li key={index} className="text-sm text-gray-700 flex items-start space-x-3">
                                    <div className="w-1.5 h-1.5 bg-indigo-500 rounded-full mt-2 flex-shrink-0"></div>
                                    <span className="leading-relaxed">{disruption}</span>
                                  </li>
                                ))}
                              </ul>
                            </div>
                        ...
                        {/* Competitive Threats */}
                        {research.demand_side.dynamicElements.competitiveThreats && (
                          <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                            ...
                            <div className="p-4">
                              <ul className="space-y-3">
                                {research.demand_side.dynamicElements.competitiveThreats.map((threat, index) => (
                                  <li key={index} className="text-sm text-gray-700 flex items-start space-x-3">
                        ...
                        {research.demand_side.dynamicElements.growthPhaseDemands && (
                          <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                            ...
                            <div className="p-4">
                              <ul className="space-y-3">
                                {research.demand_side.dynamicElements.growthPhaseDemands.map((demand, index) => (
                                  <li key={index} className="text-sm text-gray-700 flex items-start space-x-3">
