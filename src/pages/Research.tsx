...
Generated by SalesGenius.ai
  ...
  // Helper function to parse prospect profiles
  const parseProspectProfiles = (profiles) => {
    if (!profiles) return [];
  ...
  // Helper function to handle history item click
  const handleHistoryItemClick = (item) => {
    handleViewStoredResearch(item);
  };
