                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-6">
                      <div className="grid lg:grid-cols-2 gap-6 lg:grid-rows-4 lg:items-stretch">
                        ...
                        {researchResult?.demandSide?.staticElements && (
                          <div className="lg:col-start-1 lg:row-span-4 flex flex-col">
                            ...
                            <div className="grid grid-rows-4 gap-4 flex-1">
                              ...
                              {researchResult?.demandSide?.staticElements
                                ?.industryRequirements && (
                                <div className="bg-gradient-to-br from-blue-50 to-blue-100/50 border border-blue-200 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 flex flex-col">
                              ...
                              {researchResult?.demandSide?.staticElements
                                ?.operationalNeeds && (
                                <div className="bg-gradient-to-br from-green-50 to-green-100/50 border border-green-200 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 flex flex-col">
                                  <div className="bg-white border border-gray-200 rounded-lg shadow-sm flex flex-col h-full">
                              ...
                              {researchResult?.demandSide?.staticElements
                                ?.recurringProblems && (
                                <div className="bg-gradient-to-br from-orange-50 to-orange-100/50 border border-orange-200 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 flex flex-col">
                                  <div className="bg-white border border-gray-200 rounded-lg shadow-sm flex flex-col h-full">
                              ...
                              {researchResult?.demandSide?.staticElements
                                ?.geoSizeRequirements && (
                                <div className="bg-gradient-to-br from-purple-50 to-purple-100/50 border border-purple-200 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 flex flex-col">
                                  <div className="bg-white border border-gray-200 rounded-lg shadow-sm flex flex-col h-full">
                        ...
                        {researchResult?.demandSide?.dynamicElements && (
                          <div className="lg:col-start-2 lg:row-span-4 flex flex-col">
                            <h4 className="text-lg font-semibold text-gray-900 mb-4">
                              Dynamic Demand Elements
                            </h4>
                            ...
                            <div className="grid grid-rows-4 gap-4 flex-1">
                              ...
                              {researchResult?.demandSide?.dynamicElements
                                ?.marketPressures && (
                                <div className="bg-gradient-to-br from-red-50 to-red-100/50 border border-red-200 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 flex flex-col">
                                  <div className="bg-white border border-gray-200 rounded-lg shadow-sm flex flex-col h-full">
                              ...
                              {researchResult?.demandSide?.dynamicElements
                                ...
                                <div className="bg-gradient-to-br from-indigo-50 to-indigo-100/50 border border-indigo-200 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 flex flex-col">
                                  <div className="bg-white border border-gray-200 rounded-lg shadow-sm flex flex-col h-full">
                              ...
                              {researchResult?.demandSide?.dynamicElements
                                ?.competitiveThreats && (
                                <div className="bg-gradient-to-br from-yellow-50 to-yellow-100/50 border border-yellow-200 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 flex flex-col">
                                  <div className="bg-white border border-gray-200 rounded-lg shadow-sm flex flex-col h-full">
                              ...
                              {researchResult?.demandSide?.dynamicElements
                                ?.growthPhaseDemands && (
                                <div className="bg-gradient-to-br from-teal-50 to-teal-100/50 border border-teal-200 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 flex flex-col">
                                  <div className="bg-white border border-gray-200 rounded-lg shadow-sm flex flex-col h-full">
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="grid lg:grid-cols-2 gap-6 lg:items-stretch">
                            {/* Industry Requirements */}
                            {researchResult?.demandSide?.staticElements?.industryRequirements && (
                              <div className="bg-gradient-to-br from-blue-50 to-blue-100/50 border border-blue-200 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 flex flex-col h-full">
                                <div className="px-5 py-4 border-b border-blue-200/50 flex-shrink-0">
                                ...
                                <div className="p-5 flex-1">
                                  <ul className="space-y-3">
                                    {researchResult?.demandSide?.staticElements?.industryRequirements.map((req, index) => (
                                      <li key={index} className="text-sm text-blue-800 flex items-start space-x-3">
                                        <span className="text-blue-600 mt-0.5 flex-shrink-0 font-medium">✓</span>
                            ...
                            {/* Market Pressures */}
                            {researchResult?.demandSide?.dynamicElements?.marketPressures && (
                              <div className="bg-gradient-to-br from-red-50 to-red-100/50 border border-red-200 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 flex flex-col h-full">
                                <div className="px-5 py-4 border-b border-red-200/50 flex-shrink-0">
                                ...
                                <div className="p-5 flex-1">
                                  <ul className="space-y-3">
                                    {researchResult?.demandSide?.dynamicElements?.marketPressures?.map((pressure, index) => (
                                      <li key={index} className="text-sm text-red-800 flex items-start space-x-3">
                                        <span className="text-red-600 mt-0.5 flex-shrink-0 font-medium">⚡</span>
                                        <span className="leading-relaxed font-medium">
                                          {pressure.startsWith("SC- Supply context") ? (
                                            <>
                                              ...
                                              {pressure.substring("SC- Supply context".length)}
                                            </>
                                          ) : (
                                            pressure
                                          )}
                          ...
                          <div className="grid lg:grid-cols-2 gap-6 lg:items-stretch">
                            {/* Operational Needs */}
                            {researchResult?.demandSide?.staticElements?.operationalNeeds && (
                              <div className="bg-gradient-to-br from-green-50 to-green-100/50 border border-green-200 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 flex flex-col h-full">
                                <div className="px-5 py-4 border-b border-green-200/50 flex-shrink-0">
                                ...
                                <div className="p-5 flex-1">
                                  <ul className="space-y-3">
                                    {researchResult?.demandSide?.staticElements?.operationalNeeds?.map((need, index) => (
                                      <li key={index} className="text-sm text-green-800 flex items-start space-x-3">
                                        <span className="text-green-600 mt-0.5 flex-shrink-0 font-medium">✓</span>
                            ...
                            {/* Technology Disruptions */}
                            {researchResult?.demandSide?.dynamicElements?.technologyDisruptions && (
                              <div className="bg-gradient-to-br from-indigo-50 to-indigo-100/50 border border-indigo-200 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 flex flex-col h-full">
                                <div className="px-5 py-4 border-b border-indigo-200/50 flex-shrink-0">
                                ...
                                <div className="p-5 flex-1">
                                  <ul className="space-y-3">
                                    {researchResult?.demandSide?.dynamicElements?.technologyDisruptions?.map((disruption, index) => (
                                      <li key={index} className="text-sm text-indigo-800 flex items-start space-x-3">
                                        <span className="text-indigo-600 mt-0.5 flex-shrink-0 font-medium">⚡</span>
                                        <span className="leading-relaxed font-medium">
                                          {disruption.startsWith("SC- Supply context") ? (
                                            <>
                                              <span className="bg-blue-50/80 text-blue-700 px-3 py-1.5 rounded-full text-xs font-medium border border-blue-200/50 shadow-sm mr-2">
                                                Organisations value
                                              </span>
                                              {disruption.substring("SC- Supply context".length)}
                                            </>
                                          ) : (
                                            disruption
                                          )}
                          ...
                          <div className="grid lg:grid-cols-2 gap-6 lg:items-stretch">
                            {/* Recurring Problems */}
                            {researchResult?.demandSide?.staticElements?.recurringProblems && (
                              <div className="bg-gradient-to-br from-orange-50 to-orange-100/50 border border-orange-200 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 flex flex-col h-full">
                                <div className="px-5 py-4 border-b border-orange-200/50 flex-shrink-0">
                                ...
                                <div className="p-5 flex-1">
                                  <ul className="space-y-3">
                                    {researchResult?.demandSide?.staticElements?.recurringProblems?.map((problem, index) => (
                                      <li key={index} className="text-sm text-orange-800 flex items-start space-x-3">
                                        <span className="text-orange-600 mt-0.5 flex-shrink-0 font-medium">✓</span>
                                        <span className="leading-relaxed font-medium">{problem}</span>
                                      </li>
                                    ))}
                                  </ul>
                                </div>
                            ...
                            {/* Competitive Threats */}
                            {researchResult?.demandSide?.dynamicElements?.competitiveThreats && (
                              <div className="bg-gradient-to-br from-yellow-50 to-yellow-100/50 border border-yellow-200 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 flex flex-col h-full">
                                <div className="px-5 py-4 border-b border-yellow-200/50 flex-shrink-0">
                                ...
                                <div className="p-5 flex-1">
                                  <ul className="space-y-3">
                                    {researchResult?.demandSide?.dynamicElements?.competitiveThreats?.map((threat, index) => (
                                      <li key={index} className="text-sm text-yellow-800 flex items-start space-x-3">
                                        <span className="text-yellow-600 mt-0.5 flex-shrink-0 font-medium">⚡</span>
                                        <span className="leading-relaxed font-medium">
                                          {threat.startsWith("SC- Supply context") ? (
                                            <>
                                              <span className="bg-blue-50/80 text-blue-700 px-3 py-1.5 rounded-full text-xs font-medium border border-blue-200/50 shadow-sm mr-2">
                                                Organisations value
                                              </span>
                                              {threat.substring("SC- Supply context".length)}
                                            </>
                                          ) : (
                                            threat
                                          )}
                          ...
                          <div className="grid lg:grid-cols-2 gap-6 lg:items-stretch">
                            {/* Geographic & Size Requirements */}
                            {researchResult?.demandSide?.staticElements?.geoSizeRequirements && (
                              <div className="bg-gradient-to-br from-purple-50 to-purple-100/50 border border-purple-200 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 flex flex-col h-full">
                                <div className="px-5 py-4 border-b border-purple-200/50 flex-shrink-0">
                                ...
                                <div className="p-5 flex-1">
                                  <ul className="space-y-3">
                                    {researchResult?.demandSide?.staticElements?.geoSizeRequirements?.map((req, index) => (
                                      <li key={index} className="text-sm text-purple-800 flex items-start space-x-3">
                                        <span className="text-purple-600 mt-0.5 flex-shrink-0 font-medium">✓</span>
                                        <span className="leading-relaxed font-medium">{req}</span>
                                      </li>
                                    ))}
                                  </ul>
                            ...
                            {/* Growth Phase Demands */}
                            {researchResult?.demandSide?.dynamicElements?.growthPhaseDemands && (
                              <div className="bg-gradient-to-br from-teal-50 to-teal-100/50 border border-teal-200 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 flex flex-col h-full">
                                <div className="px-5 py-4 border-b border-teal-200/50 flex-shrink-0">
                                ...
                                <div className="p-5 flex-1">
                                  <ul className="space-y-3">
                                    {researchResult?.demandSide?.dynamicElements?.growthPhaseDemands?.map((demand, index) => (
                                      <li key={index} className="text-sm text-teal-800 flex items-start space-x-3">
                                        <span className="text-teal-600 mt-0.5 flex-shrink-0 font-medium">⚡</span>
                                        <span className="leading-relaxed font-medium">
                                          {demand.startsWith("SC- Supply context") ? (
                                            <>
                                              <span className="bg-blue-50/80 text-blue-700 px-3 py-1.5 rounded-full text-xs font-medium border border-blue-200/50 shadow-sm mr-2">
                                                Organisations value
                                              </span>
                                              {demand.substring("SC- Supply context".length)}
                                            </>
                                          ) : (
                                            demand
                                          )}
