                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-6">
                      <div className="grid lg:grid-cols-2 gap-6">
                        ...
                        {console.log(
                          researchResult,
                          researchResult?.demand_side,
                          researchResult?.demand_side?.staticElements
                          ...
                          <div className="space-y-4">
                              ...
                              <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                                ...
                                <div className="p-4">
                                  <ul className="space-y-3">
                                    {researchResult?.demand_side?.staticElements?.industryRequirements.map(
                                      (req, index) => (
                                        <li
                                          key={index}
                            ...
                            {researchResult?.demand_side?.staticElements
                              ...
                              <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                                ...
                                <div className="p-4">
                                  <ul className="space-y-3">
                                    {researchResult?.demand_side?.staticElements?.operationalNeeds?.map(
                                      (need, index) => (
                                        <li
                                          key={index}
                                          className="text-sm text-gray-700 flex items-start space-x-3"
                            ...
                            {researchResult?.demand_side?.staticElements
                              ...
                              <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                                ...
                                <div className="p-4">
                                  <ul className="space-y-3">
                                    {researchResult?.demand_side?.staticElements?.recurringProblems?.map(
                                      (problem, index) => (
                                        <li
                                          key={index}
                                          className="text-sm text-gray-700 flex items-start space-x-3"
                            ...
                            {researchResult?.demand_side?.staticElements
                              ...
                              <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                                ...
                                <div className="p-4">
                                  <ul className="space-y-3">
                                    {researchResult?.demand_side?.staticElements?.geoSizeRequirements?.map(
                                      (req, index) => (
                                        <li
                                          key={index}
                                          className="text-sm text-gray-700 flex items-start space-x-3"
                        ...
                        {researchResult?.demand_side?.dynamicElements && (
                          <div className="space-y-4">
                            <h4 className="text-lg font-semibold text-gray-900 mb-4">
                              Dynamic Demand Elements
                            </h4>
                            ...
                            {researchResult?.demand_side?.dynamicElements
                              ...
                              <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                                ...
                                <div className="p-4">
                                  <ul className="space-y-3">
                                    {researchResult?.demand_side?.dynamicElements?.marketPressures?.map(
                                      (pressure, index) => (
                                        <li
                                          key={index}
                                          className="text-sm text-gray-700 flex items-start space-x-3"
                            ...
                            {researchResult?.demand_side?.dynamicElements
                              ...
                              <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                                ...
                                <div className="p-4">
                                  <ul className="space-y-3">
                                    {researchResult?.demand_side?.dynamicElements?.technologyDisruptions?.map(
                                      (disruption, index) => (
                                        <li
                                          key={index}
                                          className="text-sm text-gray-700 flex items-start space-x-3"
                            ...
                            {researchResult?.demand_side?.dynamicElements
                              ...
                              <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                                ...
                                <div className="p-4">
                                  <ul className="space-y-3">
                                    {researchResult?.demand_side?.dynamicElements?.competitiveThreats?.map(
                                      (threat, index) => (
                                        <li
                                          key={index}
                                          className="text-sm text-gray-700 flex items-start space-x-3"
                            ...
                            {researchResult?.demand_side?.dynamicElements
                              ...
                              <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                                ...
                                <div className="p-4">
                                  <ul className="space-y-3">
                                    {researchResult?.demand_side?.dynamicElements?.growthPhaseDemands?.map(
                                      (demand, index) => (
                                        <li
                                          key={index}
                                          className="text-sm text-gray-700 flex items-start space-x-3"
