        ...
        if (researchResult?.demandSide) {
          ...
          if (researchResult.demandSide.staticElements) {
            ...
            if (
              ...
              researchResult.demandSide.staticElements.industryRequirements.forEach(
                (req, index) => {
                  textToCopy += `• ${req}\n`;
                }
              );
            ...
            if (
              ...
              researchResult.demandSide.staticElements.operationalNeeds.forEach(
                (need, index) => {
                  textToCopy += `• ${need}\n`;
                }
              );
            ...
            if (
              ...
              researchResult.demandSide.staticElements.recurringProblems.forEach(
                (problem, index) => {
                  textToCopy += `• ${problem}\n`;
                }
              );
            ...
            if (
              ...
              researchResult.demandSide.staticElements.geoSizeRequirements.forEach(
                (req, index) => {
                  textToCopy += `• ${req}\n`;
                }
              );
          ...
          if (researchResult.demandSide.dynamicElements) {
            ...
            if (
              ...
              researchResult.demandSide.dynamicElements.marketPressures.forEach(
                (pressure, index) => {
                  textToCopy += `• ${pressure}\n`;
                }
              );
            ...
            if (
              ...
              researchResult.demandSide.dynamicElements.technologyDisruptions.forEach(
                (disruption, index) => {
            ...
            if (
              ...
              researchResult.demandSide.dynamicElements.competitiveThreats.forEach(
                (threat, index) => {
                  textToCopy += `• ${threat}\n`;
                }
              );
            ...
            if (
              ...
              researchResult.demandSide.dynamicElements.growthPhaseDemands.forEach(
                (demand, index) => {
                  textToCopy += `• ${demand}\n`;
                }
              );
