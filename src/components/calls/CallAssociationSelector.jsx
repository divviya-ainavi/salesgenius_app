    ...
    <>
      <Card className="w-full border-none shadow-none">
        <CardContent className="space-y-4">
          ...
          {/* Research Company Selection Step */}
            ...
            <div className="space-y-3">
              ...
              <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                ...
                <p className="text-sm text-blue-700 mb-3">
                  We found {researchCompanies.length} research profile(s) for "{selectedCompany.name}". 
                  Select one to enhance AI processing with existing research data.
                </p>
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex-1">
                          <h4 className="font-medium text-sm">{research.company_name}</h4>
          ...
          {currentState === SELECTOR_STATES.COMPLETE && (
            <div className="space-y-3">
              ...
              {/* Research Company Matching Section */}
              {isLoadingResearch && (
                <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                  <div className="flex items-center space-x-3">
                    <Loader2 className="w-5 h-5 animate-spin text-blue-600" />
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-blue-600">
                        Looking for existing research profiles for "{selectedCompany?.name}"
                      </p>
                    </div>
                  </div>
                </div>
              ...
              {researchCompanies.length > 0 && !isLoadingResearch && (
                <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg space-y-3">
                  ...
                  <p className="text-sm text-blue-700 mb-3">
                    Company "{selectedCompany?.name}" matches with {researchCompanies.length} research profile(s). 
                    Select one to enhance AI processing with existing research data.
                  </p>
                          ...
                          <div className="flex-1">
                            ...
                            {research.summary_note && (
                              <p className="text-xs text-muted-foreground mt-1 line-clamp-2">
                                {research.summary_note.substring(0, 150)}...
                              </p>
                            )}
                          </div>
                          {selectedResearchCompany?.id === research.id && (
