        ...
        <Tabs defaultValue="profile" className="flex-1 flex flex-col min-h-0">
          <TabsList className="grid w-full grid-cols-6 flex-shrink-0 mb-4">
            <Tooltip>
              ...
              <TooltipContent side="bottom" className="bg-gray-900 text-white text-xs px-2 py-1 rounded shadow-lg">
          ...
          {/* Profile Tab */}
            <TabsContent value="profile" className="space-y-4 mt-0 h-full overflow-y-auto">
            <Card>
              <CardHeader>
          ...
          {/* Performance Tab */}
            <TabsContent value="performance" className="space-y-4 mt-0 h-full overflow-y-auto">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
          ...
          {/* Relationships Tab */}
            <TabsContent value="relationships" className="space-y-4 mt-0 h-full overflow-y-auto">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
          ...
          {/* Selling Style Tab */}
            <TabsContent value="selling-style" className="space-y-4 mt-0 h-full overflow-y-auto">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
          ...
          {/* Objections Tab */}
            <TabsContent value="objections" className="space-y-4 mt-0 h-full overflow-y-auto">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
          ...
          {/* Availability Tab */}
            <TabsContent value="availability" className="space-y-4 mt-0 h-full overflow-y-auto">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
