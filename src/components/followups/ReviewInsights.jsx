...
// Insight type configurations with icons and colors - Updated to include all types
const insightTypes = {
  prospect_mention: {
    icon: MessageSquare,
  ...
  // Additional insight types to prevent undefined errors
  buying_signal: {
    icon: TrendingUp,
    label: "Buying Signal",
    color: "bg-emerald-100 text-emerald-800 border-emerald-200",
    description: "Strong indicators of purchase intent",
  },
  pain_point: {
    icon: AlertTriangle,
    label: "Pain Point",
    color: "bg-red-100 text-red-800 border-red-200",
    description: "Customer challenges and problems",
  },
  competitive_advantage: {
    icon: Shield,
    label: "Competitive Advantage",
    color: "bg-cyan-100 text-cyan-800 border-cyan-200",
    description: "Our advantages over competitors",
  },
  stakeholder_dynamics: {
    icon: Users,
    label: "Stakeholder Dynamics",
    color: "bg-violet-100 text-violet-800 border-violet-200",
    description: "Decision maker relationships and influence",
  },
  urgency_driver: {
    icon: Timer,
    label: "Urgency Driver",
    color: "bg-amber-100 text-amber-800 border-amber-200",
    description: "Factors creating time pressure",
  },
  technical_requirement: {
    icon: Zap,
    label: "Technical Requirement",
    color: "bg-slate-100 text-slate-800 border-slate-200",
    description: "Technical needs and specifications",
  },
  budget_insight: {
    icon: Target,
