/*
  ...
  1. New Policies
    - Re-add essential RLS policies for the profiles table
    - Enable users to read and update their own profiles
    - Allow OTP verification operations
    - Restore demo user access

  2. Security
    - Ensure RLS is enabled on profiles table
    - Create policies that work with both Supabase auth and custom auth
