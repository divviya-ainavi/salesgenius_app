/*
  # Add uploaded_file_id foreign key to call_insights table

  1. Schema Updates
    - Add uploaded_file_id column to call_insights table
    - Add foreign key constraint to uploaded_files table
    - Create index for better query performance

  2. Purpose
    - Enable direct relationship between call_insights and uploaded_files
    - Support file processing workflow
    - Allow querying insights by file and vice versa
*/
