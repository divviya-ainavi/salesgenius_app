/*
  # Business Knowledge File Management System

  1. Storage Bucket
    - Create `business-knowledge` bucket for file storage
    - Set up RLS policies for organization-based access

  2. Database Table
    - `business_knowledge_files` table for file metadata
    - Organization-based isolation with proper relationships
